...
def keyboardListener(key, x, y):
    ...
    if key == b'a':
        player_pos[0] += 20 * math.cos(angle + math.pi/2)
        player_pos[1] += 20 * math.sin(angle + math.pi/2)
