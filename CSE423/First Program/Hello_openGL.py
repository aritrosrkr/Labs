...
def draw_line(x, y):
    ...
    glVertex2f(x, y)        # Specify the (x, y) coordinate of the point
    glVertex2f(x+20, y-20)   # Specify the (x, y) coordinate of the point
    glEnd()                 # Finish drawing
...
# ===== Display callback =====
def display():
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)  # type: ignore # Clear screen and depth buffer
